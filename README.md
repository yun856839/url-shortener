...
# url-shortener
* 供使用者產生短網址
* [專案網址](https://fierce-island-71250.herokuapp.com/)

# 功能描述 (features)
* 首頁畫面上有一個表單，使用者可以在表單輸入原始網址，送出表單之後，畫面會回傳格式化後的短網址，如`https://fierce-island-71250.herokuapp.com/6y7UP`輸出格式為 5 碼英數組合短網址
